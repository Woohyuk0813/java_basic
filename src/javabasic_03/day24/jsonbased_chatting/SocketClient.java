...
public class SocketClient {
    ...
    DataOutputStream dos;   // 문자열을 읽을 때
    DataInputStream dis;    // 문자열을 보낼 때
    ...
    //메소드 : JSON 메세지 받기 : 클라이언트가 보낸 JSON 메세지를 읽는 얻무를 수행한다.
    ...
    //클라이언트가 채팅을 종료할 경우 dis.UTF()에서 IOEexception 발생하므로 예외처리를 하여,
